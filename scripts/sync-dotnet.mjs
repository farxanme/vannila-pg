...
<div id="payment-init-data"
     ...
     data-transaction-id="@((initData?.TransactionId) ?? string.Empty)"
     data-ref-num="@((initData?.RefNum) ?? string.Empty)"
     data-terminal-number="@((initData?.TerminalNumber) ?? string.Empty)"
