...
export default {
  ...
  'helpDrawer.securityBody':
    ...
    'برای دریافت اطلاعات بیشتر، گزارش فروشگاه‌های مشکوک یا استعلام وضعیت پذیرندگان اینترنتی می‌توانید با شماره 021-84080 تماس بگیرید یا به ایمیل epay@sep.ir پیام ارسال کنید.',
  'helpDrawer.otpBody':
  ...
  'bill.selector.subtitle': 'یکی از قبض‌های زیر را انتخاب کنید',
