...
export default {
  ...
  'form.internetPin': 'رمز اینترنتی',
  'form.internetPin.placeholder': 'رمز اینترنتی',
  'form.internetPin.required': 'رمز اینترنتی الزامی است',
  'form.internetPin.invalidLengthRange': 'رمز اینترنتی باید بین {{min}} تا {{max}} رقم باشد',
  ...
  'form.pay': 'پرداخت',
  'form.payDynamicPin': 'پرداخت با رمز پویا',
  'form.payStaticPin': 'پرداخت با رمز ایستا',
  'form.continue': 'ادامه',
  'form.back': 'بازگشت',
