...
export default {
  ...
  'helpDrawer.securityBody':
    'Платежный шлюз SEP работает по защищенному протоколу SSL, а его адрес начинается с https://sep.shaparak.ir. Перед вводом любых данных сравните адрес в браузере с этим адресом. При любом несоответствии не продолжайте оплату.\n\n' +
    'Никому не сообщайте пароль карты, CVV2 и одноразовый пароль, включая «поддержку» по телефону.\n\n' +
    'Не оплачивайте через публичные сети, открытый Wi-Fi и на общих устройствах.\n\n' +
    'Проверьте имя продавца и сумму к оплате; продолжайте только после подтверждения.\n\n' +
    'Чтобы снизить риск утечки данных, по возможности используйте защищенную/виртуальную клавиатуру.\n\n' +
    'После завершения, особенно на общих компьютерах, выйдите из аккаунта и закройте браузер.\n\n' +
    'Для дополнительной информации, сообщений о подозрительных магазинах или проверки статуса интернет-продавцов звоните 021-84080 или пишите на epay@sep.ir.',
  'helpDrawer.otpBody':
    'Динамический пароль — это одноразовый код, который используется вместо интернет-пароля карты.\n\n' +
    'Запрашивайте динамический пароль только когда готовы к финальному подтверждению оплаты. Введите код до окончания срока действия; если срок истек, запросите новый и не используйте старые коды.\n\n' +
    'Если пришло несколько кодов, вводите только последний действующий код и никому его не сообщайте.\n\n' +
    'Шаг 1: Активируйте динамический пароль по инструкции банка-эмитента вашей карты.\n\n' +
    'Шаг 2: Получите динамический пароль одним из способов, указанных банком-эмитентом:\n' +
    '1- Приложение банка, интернет-банк или мобильный банк.\n' +
    '2- USSD-код банка-эмитента.\n' +
    '3- Кнопка "Получить OTP" на платежном шлюзе.\n\n' +
    'Шаг 3: После получения кода введите его в поле "Второй пароль/OTP", затем заполните остальные данные и завершите оплату.',
  'helpDrawer.paymentBody':
    'Для оплаты внимательно укажите следующие данные:\n' +
    '1- Номер карты: 16 цифр, напечатанных на карте в четырех группах по 4 цифры.\n' +
    '2- CVV2: Защитный код из 3 или 4 цифр на лицевой или обратной стороне карты.\n' +
    '3- Срок действия: Месяц и год окончания срока действия рядом с номером карты.\n' +
    '4- Динамический пароль: Может отображаться как второй пароль или интернет-пароль; его можно получить/изменить через банк-эмитент или его банкоматы.\n' +
    '5- Код безопасности (captcha): Числовой код на изображении страницы оплаты, который нужно ввести в соответствующее поле.\n\n' +
    'Перед подтверждением оплаты проверьте сумму и имя продавца.\n\n' +
    'После успешной оплаты сохраните чек до получения товара или услуги.\n\n' +
    'Если заметили что-то необычное, прекратите оплату и обратитесь через официальные каналы банка или продавца.',
  ...
  'bill.selector.subtitle': 'Выберите один из счетов ниже',
