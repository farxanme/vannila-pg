...
export default {
  ...
  'form.internetPin': 'Internet sifresi',
  'form.internetPin.placeholder': 'Internet sifresi',
  'form.internetPin.required': 'Internet sifresi gereklidir',
  'form.internetPin.invalidLengthRange':
    'Internet sifresi {{min}} ile {{max}} hane arasında olmalıdır',
  ...
  'form.pay': 'Öde',
  'form.payDynamicPin': 'Dinamik sifre ile ode',
  'form.payStaticPin': 'Sabit sifre ile ode',
  'form.continue': 'Devam',
  'form.back': 'Geri',
  ...
  'receipt.internetTitle': 'İşlem ayrıntıları',
  ...
  'receipt.completeAndReturn': 'Süreci bitir ve satıcı sitesine dön',
  ...
  'receipt.merchantNumber': 'Satıcı numarası',
  'receipt.terminalNumber': 'Terminal numarası',
  'receipt.gatewayCode': 'Geçit kodu',
  'receipt.paymentFacilitator': 'Ödeme sağlayıcısı',
  'receipt.merchantSiteAddress': 'Satıcı site adresi',
  'receipt.noticePolicy':
    "Satici, mal veya hizmet teslim onayini 30 dakika icinde SEP'e bildirmezse, cekilen tutar 72 saat icinde hesabiniza iade edilir.",
  ...
  'transaction.billListTitle': 'Fatura Listesi',
  'transaction.billItem': 'Fatura',
  'transaction.billCount': '{count} fatura',
