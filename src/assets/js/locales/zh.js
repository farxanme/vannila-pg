...
export default {
  ...
  'helpDrawer.securityBody':
    'SEP 在线支付网关通过安全 SSL 协议提供服务，其地址以 https://sep.shaparak.ir 开头。输入任何信息前，请将浏览器中的地址与该地址进行核对；如发现不一致，请勿继续支付。\n\n' +
    '请勿向任何人透露银行卡密码、CVV2 或一次性密码，包括电话客服。\n\n' +
    '请避免在公共网络、开放 Wi-Fi 或共享设备上进行支付。\n\n' +
    '请核对商户名称和支付金额，仅在确认无误后继续支付。\n\n' +
    '为降低信息泄露风险，请尽量使用安全/虚拟键盘。\n\n' +
    '操作完成后，尤其在共享电脑上，请退出账户并关闭浏览器。\n\n' +
    '如需更多信息、举报可疑商户或查询互联网商户状态，请致电 021-84080 或发送邮件至 epay@sep.ir。',
  'helpDrawer.otpBody':
    '动态密码是一次性密码，用于替代银行卡网银密码。\n\n' +
    '仅在准备进行最终支付确认时再申请动态密码。请在有效期内输入验证码；若已过期，请重新获取新码，勿重复使用旧码。\n\n' +
    '若收到多条验证码，请仅输入最新且有效的一条，并且不要告知他人。\n\n' +
    '步骤 1：按照发卡行说明开通动态密码服务。\n\n' +
    '步骤 2：通过发卡行提供的任一方式获取动态密码：\n' +
    '1- 银行应用、网银或手机银行。\n' +
    '2- 发卡行 USSD 代码。\n' +
    '3- 支付网关中的“获取 OTP”按钮。\n\n' +
    '步骤 3：获取后，在“二次密码/OTP”栏输入该密码，然后补全其余信息并完成支付。',
  'helpDrawer.paymentBody':
    '为完成支付，请准确填写以下信息：\n' +
    '1- 卡号：16 位数字，通常印在卡面上并按 4 组 4 位显示。\n' +
    '2- CVV2：3 位或 4 位安全码，印在卡片正面或背面。\n' +
    '3- 有效期：包含到期月份和年份，通常位于卡号附近。\n' +
    '4- 动态密码：也可能显示为二次密码或网银密码，可通过发卡行或其 ATM 获取/修改。\n' +
    '5- 安全码（验证码）：支付页图片中的数字，需要填写到对应输入框。\n\n' +
    '提交支付前，请核对金额与商户名称。\n\n' +
    '支付成功后，请妥善保留回执，直至商品或服务交付完成。\n\n' +
    '如发现任何异常，请停止支付，并通过银行或商户官方渠道处理。',
  ...
  'bill.selector.subtitle': '请选择以下账单之一',
